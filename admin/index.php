            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php"><h1>VIT e-Library</h1> </a>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2021 VIT Chennai Library </b>All rights reserved.
            </div>
        </div>
